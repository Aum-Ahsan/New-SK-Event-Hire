      ...
      <main>
        ...
        <article id="booking-article" className="help-article">
          <div className="help-width">
            ...
            <div>
              ...
              <blockquote>✓ Your existing booking remains confirmed until an updated version is approved.</blockquote>
        ...
        <section className="safe-use">
          <div className="help-width">
            ...
            <blockquote>⚠ Do not relocate marquees, heaters, staging or electrical equipment after professional setup.</blockquote>
          </div>
        </section>
